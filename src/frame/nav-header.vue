<template>
  <div class="header-box">
    ...
    <div class="banner">
      <el-menu class="nav-menu" mode="horizontal" router="true" 
          background-color="#20a0ff" text-color="#fff" active-text-color="#ffd04b">
        <el-menu-item index="/system">系统管理</el-menu-item>
        <el-menu-item index="/jobs">招聘管理</el-menu-item>
        <el-menu-item index="/cms">信息发布</el-menu-item>
        <el-menu-item index="/docs" disabled>公文系统</el-menu-item>
        <el-submenu >
          <template slot="title">友情链接</template>
          <el-menu-item >链接1</el-menu-item>
          <el-menu-item >链接2</el-menu-item>
          <el-menu-item >链接3</el-menu-item>
        </el-submenu>
      </el-menu>
      <!--下拉用户菜单-->
